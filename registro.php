    ...
    <form id="registro" class="registro" action="index.html" method="post">
            ...
            <ul class="lista-precios clearfix">
                <li>
                  <div class="tabla-precio">
                    ...
                    <div class="orden">
                        <label for="pase_día">Boletos deseados:</label>
                        <input type="number" min="0" id="pase_día" size="3" placeholder="0">
                    </div>
                  </div>
                </li>
                <li>
                ...
                <li>
                  <div class="tabla-precio">
                    ...
                    <div class="orden">
                        <label for="pase_dosdías">Boletos deseados:</label>
                        <input type="number" min="0" id="pase_dosdías" size="3" placeholder="0">
                    </div>
                  </div>
                </li>
              </ul>
        ...
        <div id="eventos" class="eventos clearfix">
          <h3>Elije tus talleres</h3>
            <div class="caja">
              <div id="viernes" class="contenido-día clearfix">
                <h4>Viernes</h4>
                  <div>
                    <p>Talleres:</p>
              ...
              <div id="sábado" class="contenido-día clearfix">
                <h4>Sábado</h4>
                  <div>
                    <p>Talleres:</p>
              ...
              <div id="domingo" class="contenido-día clearfix">
                <h4>Domingo</h4>
                  <div>
                    <p>Talleres:</p>
                  ...
                  <div>
                    ...
                    <label><input type="checkbox" name="registro" id="conf_09" value="conf_09"><time>19:00</time> Frameworks y librerías Open Source</label>
                  </div>
                  <div>
                    <p>Seminarios:</p>
            ...
            <div class="extras">
              ...
              <div class="orden">
                ...
                <select id="regalo" required>
                  ...
                  <option value="BOL">Bolígrafos</option>
                </select>
              </div><!--.orden-->
